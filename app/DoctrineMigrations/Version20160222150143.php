 ...
 */
class Version20160222150143 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE UserDocument (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, updatedAt DATETIME NOT NULL, file_name VARCHAR(255) DEFAULT NULL, projectHolder_id INT DEFAULT NULL, INDEX IDX_156BCCAF4F912EC8 (projectHolder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
